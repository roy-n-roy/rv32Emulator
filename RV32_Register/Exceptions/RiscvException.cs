...
namespace RV32_Register.Exceptions {
    ...
    public class RiscvEnvironmentCallException : RiscvException {
        ...
        /// <param name="message">エラーを説明するメッセージ</param>
        public RiscvEnvironmentCallException(PrivilegeLevel currentLevel, RV32_RegisterSet rs, string message) : base((RiscvExceptionCause)((byte)currentLevel | 0x8U), 0, rs, message) {
        }
